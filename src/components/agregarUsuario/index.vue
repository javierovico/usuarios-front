    ...
    methods: {
      guardar(){
        ...
        .catch((error) =>{
          ...
          this.nombre.error = (errorMensaje.first_name !== undefined)?errorMensaje.first_name[0]:'';
          this.apellido.error = (errorMensaje.last_name !== undefined)?errorMensaje.last_name[0]:'';
          this.password.error = (errorMensaje.password !== undefined)?errorMensaje.password[0]:'';
          this.username.error = (errorMensaje.username !== undefined)?errorMensaje.username[0]:'';
          this.name.error = (errorMensaje.name !== undefined)?errorMensaje.name[0]:'';
